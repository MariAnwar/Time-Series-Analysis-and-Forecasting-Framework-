...
from SARIMAModel import SARIMA_Model
from SARIMAXModel import SARIMAX_Model
...
class Model_Selection():
    def __init__(self, data: pd.DataFrame,
                  model: Literal['SARIMA','SARIMAX','SARIMA-GARCH','LSTM','TACTIS-2'], forecast_horizon: int):
